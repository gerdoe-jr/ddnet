...
anim = Animation("inair_fast")
anim.back_foot.frames.Add(AnimKeyframe(0, -3, 0, -0.1))
anim.back_foot.frames.Add(AnimKeyframe(0.2, -3, 0, -0.11))
anim.back_foot.frames.Add(AnimKeyframe(0.4, -3, 0, -0.13))
anim.back_foot.frames.Add(AnimKeyframe(0.6, -3, 0, -0.11))
anim.back_foot.frames.Add(AnimKeyframe(0.8, -3, 0, -0.1))

anim.front_foot.frames.Add(AnimKeyframe(0, 3, 0, -0.1))
anim.front_foot.frames.Add(AnimKeyframe(0.2, 3, 0, -0.13))
anim.front_foot.frames.Add(AnimKeyframe(0.4, 3, 0, -0.11))
anim.front_foot.frames.Add(AnimKeyframe(0.6, 3, 0, -0.13))
anim.front_foot.frames.Add(AnimKeyframe(0.8, 3, 0, -0.1))
container.animations.Add(anim)

anim = Animation("inair_extreme")
anim.back_foot.frames.Add(AnimKeyframe(0, -5, 0, -0.1))
anim.back_foot.frames.Add(AnimKeyframe(0.2, -5, -3, -0.15))
anim.back_foot.frames.Add(AnimKeyframe(0.4, -5, -3, -0.09))
anim.back_foot.frames.Add(AnimKeyframe(0.6, -5, -3, -0.15))
anim.back_foot.frames.Add(AnimKeyframe(0.8, -5, -3, -0.1))

anim.front_foot.frames.Add(AnimKeyframe(0, 5, 0, -0.1))
anim.front_foot.frames.Add(AnimKeyframe(0.2, 5, -3, -0.09))
anim.front_foot.frames.Add(AnimKeyframe(0.4, 5, -3, -0.15))
anim.front_foot.frames.Add(AnimKeyframe(0.6, 5, -3, -0.09))
anim.front_foot.frames.Add(AnimKeyframe(0.8, 5, -3, -0.1))
container.animations.Add(anim)
